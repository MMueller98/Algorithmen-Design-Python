import unittest
import d06_prim_pq as candidate

class Test_prim_pq(unittest.TestCase):
...
suite = unittest.TestLoader().loadTestsFromTestCase(Test_prim_pq)
